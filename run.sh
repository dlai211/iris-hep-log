...
for ((i=0; i<${#pts[@]}; i+=2)); do
    ...
    screen -dmS "$session_name" bash -c "
        ...
        rm -rf OutputPT2/output_pt_${pt1} && \
        mkdir OutputPT2/output_pt_${pt1} && \
        python acts/Examples/Scripts/Python/full_chain_odd.py \
            ...
            --output OutputPT2/output_pt_${pt1}

        echo 'Running for pT = $pt2' && \
        rm -rf OutputPT2/output_pt_${pt2} && \
        mkdir OutputPT2/output_pt_${pt2} && \
        python acts/Examples/Scripts/Python/full_chain_odd.py \
            --events 100000 \
            --gun-particles 1 \
            --gun-multiplicity 1 \
            ...
            --output OutputPT2/output_pt_${pt2}
